...
<div className="relative flex flex-col items-center text-gray-700 bg-transparent shadow-none rounded-xl bg-clip-border">
  ...
  <h4 className="block font-sans text-lg pt-8 pb-3 antialiased font-semibold leading-snug tracking-normal text-blue-gray-900">
  STARLUCK® REWARDS
  </h4>
  <p className="block mt-1 font-sans text-base antialiased font-normal leading-relaxed text-gray-700">
  Join StarLucks Rewards to earn Stars for free food and drinks, any way you pay. Get access to mobile ordering, a birthday Reward, and moremore.
  </p>
  <form className="max-w-screen-lg mt-8 mb-2 w-80 sm:w-96">
    ...
    <p className="block mt-4 font-sans text-base antialiased font-normal leading-relaxed text-center text-gray-700">
      ...
      <a href="SignInForm" className="font-medium text-gray-900">
        Sign In
      </a>
    </p>
  </form>
